...
WriteLine("====== Start of EncryptionApp ==========");
...
string ciperText = Protector.Encrypt(message, password);
WriteLine($"Encypted text: {ciperText}");
...
try
{
  string clearText = Protector.Decrypt(ciperText, password2Decrypt);
