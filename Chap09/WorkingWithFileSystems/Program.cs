...
{
  WriteLine("============= OutputFileSystemInfo ================");
...
static void WorkWithFiles()
{
  ...
  textWriter.WriteLine("Hello, C#! from Inje University");
